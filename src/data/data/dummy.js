...
import { RiContactsLine, RiDashboard2Fill, RiStockLine } from 'react-icons/ri';
import {
...
import { GiLouvrePyramid, GiMoneyStack, GiConfirmed } from 'react-icons/gi';
import { GrLocation, GrBitcoin } from 'react-icons/gr';
import { TbDiscount2, TbCurrencyNaira, TbTruckDelivery } from 'react-icons/tb';
...
export const orders = [
  ...
  },
  {
    ...
    color: '#37BD6B',
    icon: <FiPackage />,
    customer: 'rodney okporoko',
    mode: 'by card',
    img: img2,
    item1: ' jollof rice',
    item2: 'fried plantain',
    item1_price: 'N1000',
    item2_price: 'N500',
    item1_amount: '2x',
    item2_amount: '1x',
